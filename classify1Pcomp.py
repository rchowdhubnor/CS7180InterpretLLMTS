...
data2f40 = np.load('/home/rahul/ICML_IntGPT/probing/data/activation/compose24f40.npy')
data4f20 = np.load('/home/rahul/ICML_IntGPT/probing/data/activation/compose28f40.npy')
data8f10 = np.load('/home/rahul/ICML_IntGPT/probing/data/activation/compose48f20.npy')
