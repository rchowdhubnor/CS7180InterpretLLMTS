...
import copy
import random 
import intervene_noise_with_signal160
...
loss_matrix_comp_25rev = intervene_noise_with_signal160.main(data_pure_lis)
np.save('/home/rahul/ICML_IntGPT/intervention_noise/result/pure160irr', loss_matrix_comp_25rev)
