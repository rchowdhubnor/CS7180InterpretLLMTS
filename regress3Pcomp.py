...
data2f40 = np.load('/home/rahul/ICML_IntGPT/probing_regression/activation/compose24f120.npy')
data4f20 = np.load('/home/rahul/ICML_IntGPT/probing_regression/activation/compose28f120.npy')
data8f10 = np.load('/home/rahul/ICML_IntGPT/probing_regression/activation/compose48f60.npy')

label2f40 = np.load('/home/rahul/ICML_IntGPT/probing_regression/min_max/compose24f120.npy')
label4f20 = np.load('/home/rahul/ICML_IntGPT/probing_regression/min_max/compose28f120.npy')
label8f10 = np.load('/home/rahul/ICML_IntGPT/probing_regression/min_max/compose48f60.npy')
...
print("linear training accuracy 24f:\n", linear_training_loss2f)
print("linear testing accuracy 24f:\n", linear_testing_loss2f)
...
print("linear training accuracy 28f:\n", linear_training_loss4f20)
print("linear testing accuracy 28f:\n", linear_testing_loss4f20)
...
print("linear training accuracy 48f:\n", linear_training_loss8f)
print("linear testing accuracy 48f:\n", linear_testing_loss8f)
# ######################################## 8f
