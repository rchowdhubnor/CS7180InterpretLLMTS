...
data2f40 = np.load('/home/rahul/ICML_IntGPT/probing/data/activation/pure2f120.npy')
data4f20 = np.load('/home/rahul/ICML_IntGPT/probing/data/activation/pure4f60.npy')
data8f10 = np.load('/home/rahul/ICML_IntGPT/probing/data/activation/pure8f30.npy')
...
for i in range(12):
    lin_class2f['lr_clf_layer' + str(i)] = LogisticRegression(penalty='l2',C=c,max_iter=1500)
...
logreg_comp=np.zeros((12,768))
for i in range(12):
    lin_class4f['lr_clf_layer' + str(i)] = LogisticRegression(penalty='l2',C=c,max_iter=1500)
    # lab_train=train_data[:,i,:]
...
logreg_comp=np.zeros((12,768))
for i in range(12):
    lin_class8f['lr_clf_layer' + str(i)] = LogisticRegression(penalty='l2',C=c,max_iter=1500)
    # lab_train=train_data[:,i,:]
